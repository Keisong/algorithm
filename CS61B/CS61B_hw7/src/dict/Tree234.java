...
public class Tree234 extends IntDictionary {
  ...
  public void insert(int key) {
	  Tree234Node node = root;
	  if (root == null) root=new Tree234Node(null,key);
	  while (node != null) {
		  if(node.keys==3) {
			  if((key == node.key1)||(key == node.key2)||(key == node.key3)) return;
			  if(node ==root) {
				  root = new Tree234Node(null,node.key2);
				  Tree234Node node1 = new Tree234Node(root,node.key1);
				  if(node.child1!=null) {
					  node1.child1=node.child1;
					  node.child1.parent=node1;
				  }
				  if(node.child2!=null) {
					  node1.child2=node.child2;
					  node.child2.parent=node1;
				  }
				  Tree234Node node2 = new Tree234Node(root,node.key3);
				  if(node.child3!=null) {
					  node2.child1=node.child3;
					  node.child3.parent=node2;
				  }
				  if(node.child4!=null) {
					  node2.child2=node.child4;
					  node.child4.parent=node2;
				  }
				  root.child1=node1;
				  root.child2=node2;
				  if(key<node.key2) node = node1;
				  else node=node2;
			  } else {
				  Tree234Node node1=new Tree234Node(node.parent,node.key1);
				  Tree234Node node3=new Tree234Node(node.parent,node.key3);
				  if(node.key2<node.parent.key1) {
					  ...
					  node.parent.keys++;
					  node.parent.child4=node.parent.child3;
					  node.parent.child3=node3;
					  node.parent.child2=node1;
				  } else {
					  node.parent.key3=node.key2;
					  node.parent.keys++;
					  node.parent.child4=node3;
					  node.parent.child3=node1;
				  }
				  if(node.child1!=null) {
					  node1.child1=node.child1;
					  node.child1.parent=node1;
				  ...
				  if(node.child3!=null) {
					  ...
					  node.child3.parent=node3;
				  }
				  if(node.child4!=null) {
					  node3.child2=node.child4;
					  node.child4.parent=node3;
				  }
				  if(key<node.key2) node = node1;
				  else node=node3;
			  } 
