...
class Date {
  ...
  public Date(String s) {
	  ...
	  {
		  String[] o = s.split("/");
		  if (!isValidDate(Integer.parseInt(o[0]),Integer.parseInt(o[0]),Integer.parseInt(o[0]))) System.exit(0);
		  this.month=Integer.parseInt(o[0]);
		  this.day=Integer.parseInt(o[1]);
		  this.year=Integer.parseInt(o[2]);
	  }
	  else System.exit(0);
  }
  ...
  public static boolean isValidDate(int month, int day, int year) {
	  ...
	  if(day<=0||day>daysInMonth(month,year)) return false;
    return true;                        
  }
